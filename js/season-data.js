...
/** Every game for the season, both sports — grading needs the FINAL score of
 * past games, not just upcoming ones, so this always covers the whole
 * season (see fetchScoreboard, js/live-scores.js, for why it's no longer a
 * date-range request — ESPN broke that query shape entirely, 2026-09-15). */
